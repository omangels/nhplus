...
public class PatientDAO extends DAOimp<Patient> {
  ...
  protected String getCreateStatementString(Patient patient) {
    return String.format(
        ...
        patient.getFirstName(), patient.getSurname(), patient.getDateOfBirth(), patient.getCareLevel(),
   ...
   * 
   * @param result
   *                 ResultSet with a single row. Columns will be mapped to a patient-object.
  ...
  protected Patient getInstanceFromResultSet(ResultSet result) throws SQLException {
    ...
    p = new Patient(result.getInt(1), result.getString(2), result.getString(3), date, result.getString(5),
        result.getString(6));
    return p;
  }
   ...
   * 
   * @param result
   *                 ResultSet with a multiple rows. Data will be mapped to patient-object.
  ...
  protected String getUpdateStatementString(Patient patient) {
    return String.format(
        ...
        patient.getFirstName(), patient.getSurname(), patient.getDateOfBirth(), patient.getCareLevel(),
        patient.getRoomnumber(), patient.getPid());
  }
